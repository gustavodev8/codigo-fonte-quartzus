...
const projects = [
  {
    ...
    image: julianaAsset.url, alt: "Página inicial do website de Juliana Cardoso", layout: "wide",
  },
  {
    ...
    image: felipeAsset.url, alt: "Página inicial do website de Felipe David", layout: "offset",
  },
  {
